fun main() {
    ...
    val publishedAgoStr: String = publishedAgo(seconds)
    println(publishedAgoStr)
}
...
fun declensionFunc(amount: Int, thing: String): String {
    when (thing) {
        "YEARS" -> {
...
fun alfabetAmount(amount: Int, sex: String): String {
